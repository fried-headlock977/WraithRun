...
5. Find the WraithRun app file and double-click it to start.
...
1. Wait a moment while it loads.
2. Read any setup screen that appears.
3. Choose a local folder for your work files if prompted.
4. Allow the app to finish its first-time setup.
5. Start with a basic task so you can see how it works.
...
3. Add the file, folder, or data source.
4. Start the run.
5. Review the output on screen.
6. Save anything you want to keep.
...
- an `.exe` file
- a `.zip` file
- support files for local runtime use
